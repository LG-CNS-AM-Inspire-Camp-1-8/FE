      ...
      <div className="modal" onClick={onClose}>
          <div className="modal-content">
            ...
            <form>
              ...
              <input type='text'className = 'textname' placeholder="제목을 입력하세요" required />
              <label className='modal_form'>기사 링크</label>
              <input type="url" className = 'textname' placeholder="기사 링크를 입력하세요" />
            
              <label className='modal_form'>사진</label>
              <div class="file-input">
                <input type="file" className='fileupload'/>
              </div>
              <button type="button" class="upload-button">업로드</button>
            </form>
